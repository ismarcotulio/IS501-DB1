...
/*
EJERCICIO 1
Todas las computadoras del inventario que no pertenecen a las marcas
de los 3 grupos de RAM anteriores. Encuentre 2 formas de resolver 
el ejercicio
*/
...
/*
EJERCICIO 2
Limitar la cantidad de registros que se muestran para la pagina 1
 de una consulta cualquiera. Ejemplo: LIMIT 2,1.
*/