...
/*
    BETWEEN: Usando el BETWEEN, haga un filtrado de los registros
    considerando los elementos con id entre valor 1 y 4 
*/

SELECT
    Source.id AS "Identificador del registro",
    Source.dec_salary AS "Salario",
    Source.flo_bigNumberA AS "Demostracion aritmetica del flotante",
    Source.dou_bigNumberB AS "Demostracion aritmetica del double"
FROM
    DataType AS Source